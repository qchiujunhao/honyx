#!/usr/bin/env python3
"""Build a result-first showcase from one verified run.

EXAMPLE, NOT A GENERIC TOOL. This version expects results/summary.json as
{"groups":[{"group","n","mean"}]} plus results/chart.svg. Adapt the result
language, tables, figures, and captions to the analysis instead of copying its
schema. Keep the page generated from rerun outputs.
"""
...
<figure><img src="chart.svg" alt="Result chart"><figcaption>Generated from the checked summary values; describe the takeaway and interpretation limit here.</figcaption></figure>
...
<footer>Publish the rerun command and a link to CI evidence with the real analysis.</footer>
</body></html>
"""
